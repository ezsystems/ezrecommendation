...
<div class="border-ml"><div class="border-mr"><div class="border-mc float-break">
    ...
    <div class="content-view-full">
        ...
        {*
        <div {generate_common_event($node, 'click')}> click here to create CLICK event </div>
        <div {generate_common_event($node, 'blacklist')}> click here to create BLACKLIST event </div>
        <div {generate_common_event($node, 'owns')}> click here to create OWNS event </div>
        <div {generate_common_event($node, 'clickrecommended')}> click here to create CLICK RECOMMENDED event </div>
        <div {generate_rate_event($node, 4)}> click here to create RATE event with value 4</div>
        *}
...
{*include uri='design:content/recommendations.tpl' view='flyout' node=$node scenario='also_clicked' limit=1 category_based=false() track_rendered_items=true() create_clickrecommended_event=true()*}
